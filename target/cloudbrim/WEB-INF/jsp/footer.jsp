        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 mb-4">
                    <img src="resources/images/icons/cloudBrimIcon.png" class="logo img-fluid" alt="">
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">Job Portal</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-12 mx-auto">
                    ...
                    <p class="text-white d-flex mb-2">
                        ...
                        <a href="tel: +1 609-359-2700" class="site-footer-link">
                            +1 609-359-2700
                        </a>
                    </p>
                    ...
                    <p class="text-white d-flex">
                        ...
                        <a href="mailto:info@cloudbrim.com" class="site-footer-link">
                            info@cloudbrim.com
                        </a>
                    </p>
